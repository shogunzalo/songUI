  ...
  $.stratus = function (settings) {
    ...
    root_url =
      settings.env === "development"
        ? "http://localhost:8888"
        : "http://www.whomixed.com";
    $("head").append(
      "<link rel='stylesheet' href='" +
        root_url +
        "/app/stratus/css/stratus.css' type='text/css'/>"
    );
    ...
    $("body").append(
      "<div id='stratus'><iframe allowtransparency='true' frameborder='0' scrolling='0'></div>"
    );
    src =
      root_url +
      "/player.html?" +
    ...
    $("#test1").click(function () {
      $.postMessage(
        $(this).attr("href"),
        src,
        $("#stratus iframe")[0].contentWindow
      );
      return false;
    });
