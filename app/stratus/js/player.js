...
//function searchNextButtonRandomSong() {
//
//    var x = Math.floor((Math.random() * 202099809) + 299);
//
//    $.ajax({
//        url : "https://api.soundcloud.com/tracks/" + x + "?client_id=ybtyKcnlhP3RKXpJ58fg&format=json",
//        success: function(data) {
//            Stratus.nextRandom(data);
//        },
//
...
$(function() {
  ...
  window.AppView = Backbone.View.extend({
    ...
    defaults: {
      ...
      download: true,
      env: 'production',
      key: '1cbeea56d857430caccee966682cf238',
